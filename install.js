...
(function () {
  ...
  style.textContent = `
    ...
    #indigeneInstallBar .ii-mark img{ width:100%; height:100%; object-fit:cover; display:block; }
    ...
    #iiModal .ii-modal-head{ display:flex; align-items:center; gap:12px; margin-bottom:18px; }
    #iiModal .ii-modal-mark{
      width:38px; height:38px; border-radius:9px; flex-shrink:0; overflow:hidden;
      background:var(--void, #07050a);
    }
    #iiModal .ii-modal-mark img{ width:100%; height:100%; object-fit:cover; display:block; }
    #iiModal h3{
      font-family:'Orbitron', sans-serif; font-weight:700; font-size:1.05rem;
      letter-spacing:0.03em; color:var(--parchment, #f2e6d8); margin-bottom:4px;
    }
    #iiModal .ii-modal-sub{
      font-family:'JetBrains Mono', monospace; font-size:0.64rem; letter-spacing:0.12em;
      text-transform:uppercase; color:var(--ember, #ff7a1a);
    }
  ...
  bar.innerHTML = `
    <div class="ii-mark"><img src="icon-192.png" alt="INDIGENE"></div>
    <div class="ii-text">
  ...
  function showIOSModal() {
    ...
    overlay.innerHTML = `
      <div id="iiModal" role="dialog" aria-modal="true">
        ...
        <div class="ii-modal-head">
          <div class="ii-modal-mark"><img src="icon-192.png" alt="INDIGENE"></div>
          <div>
